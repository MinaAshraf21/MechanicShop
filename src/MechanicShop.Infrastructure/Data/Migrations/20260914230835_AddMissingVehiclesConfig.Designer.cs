...
namespace MechanicShop.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260914230835_AddMissingVehiclesConfig")]
    partial class AddMissingVehiclesConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MechanicShop.Domain.WorkOrders.Billing.Invoice", b =>
                {
                    ...
                    b.OwnsMany("MechanicShop.Domain.WorkOrders.Billing.InvoiceLineItem", "InvoiceLineItems", b1 =>
                        {
