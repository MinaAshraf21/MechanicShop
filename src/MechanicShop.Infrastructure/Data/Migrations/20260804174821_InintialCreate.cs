        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_WorkOrders_WorkOrderId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkOrderRepairTasks", x => new { x.TasksId, x.WorkOrderId });
                    table.ForeignKey(
                        name: "FK_WorkOrderRepairTasks_RepairTasks_TasksId",
                        column: x => x.TasksId,
                        principalTable: "RepairTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
