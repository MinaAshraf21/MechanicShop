...
public static class CustomerErrors
{
  ...
  public static Error CannotDeleteCustomerWithWorkOrders => Error.Conflict("CustomerErrors.CannotDeleteCustomerWithWorkOrders", "Cannot delete a customer with associated work orders.");
}