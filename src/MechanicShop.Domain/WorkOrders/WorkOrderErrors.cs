...
public static class WorkOrderErrors
{
    ...
    public static Error TimingReadonly(string id, State state) => Error.Conflict(
    ...
    public static Error InvalidStateTransition(State current, State next) => Error.Conflict(
